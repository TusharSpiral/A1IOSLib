...
class EventHandler: NSObject {
    ...
    func configureEventHandler() {
        EventManager.shared.configureEventManager(appMetricaKey: "", firebase: false, facebook: false) // appMetrica and mixpanel is optional now. // Firebase and facebook is true by default if you dont want to use simply pass false
    }
